...
//	private static final long serialVersionUID = 4;
	...
	public Glamping(int no, String group, String name, String location, int remain, int price, int sales) {
		super(no, group, name, location, remain, price, sales);
		super.specialPrice = 15000;
	}	
	...
	public int specialBook() {
		while(true) {
			int tmp;
			System.out.println("바비큐를 예약하시겠습니까?(가격은 " + util.toDecFormat(specialPrice) + "원 입니다)> 1.예약한다 2.안한다");
