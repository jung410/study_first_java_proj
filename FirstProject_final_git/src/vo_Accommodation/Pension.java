...
//	private static final long serialVersionUID = 7;
	...
	Util util = new Util();
	public Pension(int no, String group, String name, String location, int remain, int price, int sales) {
		super(no, group, name, location, remain, price, sales);
		super.specialPrice = 30000;
	}
	...
	public int specialBook() {
		while(true) {
			int tmp;
			System.out.println("수영장을 예약하시겠습니까?(가격은 " + util.toDecFormat(specialPrice) + "원 입니다)> 1.예약한다 2.안한다");
